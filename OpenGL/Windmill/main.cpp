...
void display()
{
    ...
    {
        // glTranslatef(0, 0, 0);
        glRotatef(fanStandRotation, 0, 1, 0);
        // glScalef(1.0f, 1.0f, 1.0f);
        // drawCuboidal(5.0, 1.0, 5.0);
        // drawCuboidal(0.5, 1.0, 0.5);
        drawCube(1.0, 5.0, 1.0);
    }
    glPopMatrix();
    glPushMatrix();
    {
        glRotatef(fanStandRotation, 0, 1, 0);
        // glRotatef(fanRotation, 1, 0, 0);
        drawFan(5.0);
    }
    glPopMatrix();
    ...
    glPushMatrix();
    {
        glRotatef(fanStandRotation, 0, 1, 0);
        // glRotatef(fanRotation, 1, 0, 0);
        drawLine(Point(1.5, 1.5, 0), Point(-1.5, 1.5, 0.0));
    }
    glPopMatrix();
...
void drawTriangle(Point x, Point y, Point z)
{
...
void drawFan(double len)
{
    ...
    glRotatef(fanRotation, 1, 0, 0);
    drawTriangle(Point(0.0, 0.0, 0.0), Point(0.0, 1.0, 0.5), Point(0.0, 1.0, -0.5));
    glRotatef(120, 1, 0, 0);
    drawTriangle(Point(0.0, 0.0, 0.0), Point(0.0, 1.0, 0.5), Point(0.0, 1.0, -0.5));
    glRotatef(120, 1, 0, 0);
    drawTriangle(Point(0.0, 0.0, 0.0), Point(0.0, 1.0, 0.5), Point(0.0, 1.0, -0.5));
