...
void drawSquare(double a)
{
    glBegin(GL_QUADS);
    {
        glVertex3f(a, 10*a, 0);   // Top-right corner
        glVertex3f(a, -10*a, 0);  // Bottom-right corner
        glVertex3f(-a, -10*a, 0); // Bottom-left corner
        glVertex3f(-a, 10*a, 0);  // Top-left corner
    }
    glEnd();
}
...
void display()
{
    ...
    glPushMatrix();
    {
        ...
        glTranslatef(1.5, rR, 0);          // Move away from center
        // glTranslatef(0, rR, 0); 
        glColor3f(1.0f, 1.0f, 1.0f);        // Set color to red
        drawSquare(0.05);                    // Draw a square
    }
    glPopMatrix();
    ...
    glPushMatrix();
    {
        // glRotatef(squareRotation, 0, 0, 1); // Rotate around Z-axis
        // glTranslatef(lR, 0, 0); 
        glTranslatef(-1.5, lR, 0);          // Move away from center
