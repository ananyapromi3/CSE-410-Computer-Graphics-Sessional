...
void init()
{
    ...
    secHandRotation = -(seconds / 60.0f) * 360.0f;
    minHandRotation = -((minutes + seconds / 60.0f) / 60.0f) * 360.0f;
    hourHandRotation = -((hours + minutes / 60.0f) / 12.0f) * 360.0f;
...
void display()
{
    ...
    glPushMatrix();
    {
        ...
        drawCircle(1.0);             // Draw the clock face
    }
    glPopMatrix();
    ...
    glPushMatrix();
    {
        glRotatef(hourHandRotation, 0.0f, 0.0f, 1.0f); // Rotate hour hand
        glColor3f(1.0f, 1.0f, 1.0f);                   // Set color to white for hour hand
        drawHourHands(0.0, 0.0, 1.0);                  // Draw the hour hand
    }
    glPopMatrix();
    ...
    glPushMatrix();
    {
        glRotatef(minHandRotation, 0.0f, 0.0f, 1.0f); // Rotate minute hand
        glColor3f(1.0f, 1.0f, 1.0f);                  // Set color to white for minute hand
        drawMinuteHands(0.0, 0.0, 1.0);               // Draw the minute hand
    }
    glPopMatrix();
    ...
    glPushMatrix();
    {
        ...
        drawSecondHands(0.0, 0.0, 1.0);               // Draw the second hand
    }
    glPopMatrix();
...
void timerFunction(int value)
{
    ...
    secHandRotation -= 6.0f * deltaSec; // 6 degrees per second
